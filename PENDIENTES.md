...
### 2. Hero CTA apunta a `/contacto` — ruta inexistente
**Archivo:** `src/pages/public/home/s01-hero.tsx`
**Problema:** El primer botón del hero apunta a `/contacto`, que no existe en el router. El 404 redirige a home silenciosamente.
**Fix requerido:** Cambiar href/to de `/contacto` → `/aplicar` o `/#s07b`
