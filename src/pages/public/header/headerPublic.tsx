...
const NAV = [
  ...
  { name: 'TCO Waitlist',      href: '/#cloud-tco',         sectionId: 'cloud-tco' },
  ...
  { name: 'Fixed-Price',       href: '/#fixed-price',       sectionId: 'fixed-price' },
  { name: 'Casos',             href: '/#s07',               sectionId: 's07' },
  { name: 'Rescue Assessment', href: '/#rescue-assessment', sectionId: 'rescue-assessment' },
  { name: 'Industrias',        href: '/#s08',               sectionId: 's08' },
  { name: 'FABRIC OS',         href: '/#s09',               sectionId: 's09' },
  { name: 'Lifecycle',         href: '/#s10',               sectionId: 's10' },
  { name: 'Office Hours',      href: '/#s11',               sectionId: 's11' },
