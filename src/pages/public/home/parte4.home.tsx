...
function LeadPreviewCard({ onOpen, visible }: { onOpen: () => void; visible: boolean }) {
  ...
  return (
    <article className={`fabric-panel relative w-full max-w-[440px] overflow-hidden bg-bg-panel/82 p-5 shadow-[0_30px_110px_rgba(0,0,0,0.48)] backdrop-blur-md transition-all duration-700 md:p-6 ${visible ? "translate-y-0 scale-100 opacity-100 blur-0" : "translate-y-8 scale-[0.985] opacity-0 blur-sm"}`} style={{ transitionDelay: "220ms" }}>
